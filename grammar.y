...
%token STRLEN SUBSTRING EXPLODE STRSUB PAD MATCH_BEGIN MATCH_TEMPLATE
%token MATCH_PATTERN CRYPT UPPERCASE LOWERCASE STRCMP
...
%token THIS DEFINER SENDER CALLER
